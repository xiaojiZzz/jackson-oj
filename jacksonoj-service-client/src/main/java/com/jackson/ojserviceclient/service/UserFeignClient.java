...
import com.jackson.ojmodel.model.enums.UserRoleEnum;
...
import static com.jackson.ojcommon.constant.UserConstant.USER_LOGIN_STATE;
 ...
 * @author jackson
 */
@FeignClient(name = "jacksonoj-user-service", path = "/jacksonoj/user/inner")
